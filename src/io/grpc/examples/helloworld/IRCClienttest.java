...
public class IRCClienttest {
  private static final Logger logger = Logger.getLogger(IRCClienttest.class.getName());
  ...
  public IRCClienttest(String host, int port) {
    channel =
  ...
  public static void main(String[] args) throws Exception {
    ...
    IRCClienttest client = new IRCClienttest("localhost", 50051);
   try{      
